// Centralized copy for the site. Bio and press copy is written strictly from
// verified source material (the AFAA 2025 award evidence, the Independent
// Online News feature, the Dela-Fin brand mission statement, and the visual
// evidence in the designer's own photography) — nothing here invents dates,
...
export const site = {
  ...
  instagram: "https://www.instagram.com/delafin",
  instagramHandle: "@delafin",
  email: "vanessamofunanya1@gmail.com", // placeholder — replace with the preferred public inquiry address
};
...
export const homeCopy = {
  heroKicker: "Handmade in Essex, Couture · Ready-to-Wear · Custom Commissions",
  heroHeadline: "Style Lives Deeper",
  heroSub:
    "Every piece starts as a sketch pinned to the studio wall and ends its journey hand-stitched, hand-beaded, and one of one. Scroll on for the collections, the process, and the award that put Dela-Fin on the map.",
  ...
  introCaption: "In the studio - Essex, UK",
  awardEyebrow: "Recognition",
  awardHeading: "AFAA 2025 Emerging Innovative Fashion Designer of the Year",
  awardBody:
    "Presented by the African Fashion and Arts Award in Abuja, Nigeria, in recognition of her contribution to modern African fashion and creative thinking.",
  collectionsEyebrow: "The Work",
  collectionsHeading: "Explore the collections",
  ctaHeading: "Begin a commission",
  ctaBody:
    "From custom eveningwear to full collections, every Dela-Fin piece is made to order and made by hand.",
};
...
export const pressCopy = {
  ...
  articleUrl:
    "https://independent.ng/adora-vanessamofunanya-wins-afaa-2025-emerging-innovative-fashiondesigner-of-the-year/",
  commissionHeading: "Custom commission, live on stage",
  commissionBody:
    "A custom overcoat, hand-finished with three-dimensional crocheted roses trailing the lapel, was worn on stage by a Nigerian recording artist mid-performance, a full-circle moment from sketch to spotlight for the design.",
};
